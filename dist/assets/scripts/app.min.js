...
/***/ (function(module, exports, __webpack_require__) {
	...
	// const $intro = $('.intro');
	var $toggler = (0, _jquery2.default)('.js-menu-toggler');
	
	var topMenuClass = 'header_on-top';
	var fixedMenuClass = 'header_fixed';
	var crossIntroMenuClass = 'header_cross-intro';
		...
		(0, _createClass3.default)(Header, [{
			...
			value: function handleMenuToggle() {
				...
				if (!this.isMenuOpen) {
					...
					(0, _jquery2.default)('.header__menu-wrapper').scrollTop(0); // reopen menu always at top scroll position
					setTimeout(function () {
						$header.css({ transition: 'transform .5s, color .3s, background-color .3s' });
					}, 10);
				}
			}
		}, {
			...
			value: function handlePageScroll() {
				...
				if ((0, _jquery2.default)('#intro')[0] && (0, _jquery2.default)('#intro')[0].getBoundingClientRect().bottom <= 0 + $header.height() + 100) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $listToggler = (0, _jquery2.default)('.js-list-toggler');
	var openTogglerState = 'menu__list-toggler_open';
		...
		(0, _createClass3.default)(Menu, [{
			...
			value: function init() {
				$listToggler.on('click', function () {
					(0, _jquery2.default)(this).toggleClass(openTogglerState);
				});
			}
		}]);
		return Menu;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Footer = function () {
		...
		(0, _createClass3.default)(Footer, [{
			key: 'init',
			value: function init() {
				(0, _jquery2.default)('.footer__button')[0].addEventListener('click', function () {
